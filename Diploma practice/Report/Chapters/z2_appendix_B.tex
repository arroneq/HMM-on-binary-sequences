...
\vspace{1cm}
\lstinputlisting[linerange={1-7}]{Code/HMM practice code.py}

\section{Обчислення коефіцієнтів прямого та зворотного ходу}

\lstinputlisting[linerange={9-82}]{Code/HMM practice code.py}
\vspace{1cm}
\lstinputlisting[linerange={84-139}]{Code/HMM practice code.py}

\section{Алгоритм Баума-Велша}

\lstinputlisting[linerange={141-253}]{Code/HMM practice code.py}

\section{Алгоритм Вітербі}

\lstinputlisting[linerange={255-306}]{Code/HMM practice code.py}

\section{Алгоритм розв'язку задачі локалізації}

\lstinputlisting[linerange={308-388}]{Code/HMM practice code.py}