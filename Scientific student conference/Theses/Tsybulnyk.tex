    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot [
                ...
                ($d_H=0$,0.435) ($d_H=1$,0.345) ($d_H=2$,0.085) ($d_H=3$,0.135) ($d_H=4$,0.0) ($d_H=5$,0.0)
            };
        \end{axis}
    \end{tikzpicture}
...
\begin{table}[H]\centering
    ...
    \begin{tblr}{
        ...
        \widehat{\,p\,} & 0.1897 & 0.1917 & 0.2174 & 0.2193 & 0.2242  \\
        \widehat{|I_*|} & 2      & 2      & 3      & 3      & 3       \\
    \end{tblr}
